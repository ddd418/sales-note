...
urlpatterns = [
    ...
    path('funnel/api/pipeline-probability/', funnel_views.funnel_pipeline_probability, name='funnel_pipeline_probability'),
    path('funnel/api/pipeline-duplicate/', funnel_views.funnel_pipeline_duplicate, name='funnel_pipeline_duplicate'),
