...
urlpatterns = [
    ...
    path('api/companies/<int:company_id>/delete/', views.company_delete_api, name='company_delete_api'),
    path('api/departments/<int:department_id>/update/', views.department_update_api, name='department_update_api'),
    path('api/departments/<int:department_id>/delete/', views.department_delete_api, name='department_delete_api'),
    ...
    path('api/customer-assets/account-search/', views.customer_asset_account_search_api, name='customer_asset_account_search_api'),
    path('api/customer-assets/create/', views.customer_asset_directory_create_api, name='customer_asset_directory_create_api'),
    path('api/services/', views.service_cases_summary_api, name='service_cases_summary_api'),
    path('api/customer-assets/<int:asset_id>/update/', views.customer_asset_directory_update_api, name='customer_asset_directory_update_api'),
    path('api/customer-assets/<int:asset_id>/service-cases/create/', views.customer_asset_directory_service_case_save_api, name='customer_asset_directory_service_case_create_api'),
    path('api/customer-assets/<int:asset_id>/service-cases/<int:case_id>/update/', views.customer_asset_directory_service_case_save_api, name='customer_asset_directory_service_case_update_api'),
    path('api/customer-assets/<int:asset_id>/calibrations/create/', views.customer_asset_directory_calibration_save_api, name='customer_asset_directory_calibration_create_api'),
    path('api/customer-assets/<int:asset_id>/calibrations/<int:record_id>/update/', views.customer_asset_directory_calibration_save_api, name='customer_asset_directory_calibration_update_api'),
    ...
    path('api/accounts/<int:department_id>/contacts/<int:followup_id>/update/', views.account_contact_save_api, name='account_contact_update_api'),
    path('api/accounts/<int:department_id>/cleanup-preview/', views.account_cleanup_preview_api, name='account_cleanup_preview_api'),
    path('api/accounts/<int:department_id>/cleanup-merge/', views.account_cleanup_department_merge_api, name='account_cleanup_department_merge_api'),
    ...
    path('api/customers/<int:followup_id>/service-cases/<int:case_id>/update/', views.customer_service_case_save_api, name='customer_service_case_update_api'),
    path('api/customers/<int:followup_id>/calibrations/create/', views.customer_calibration_save_api, name='customer_calibration_create_api'),
    path('api/customers/<int:followup_id>/calibrations/<int:record_id>/update/', views.customer_calibration_save_api, name='customer_calibration_update_api'),
    ...
    path('api/schedules/<int:schedule_id>/ai-coach/', views.schedule_ai_coach_api, name='schedule_ai_coach_api'),
    ...
    path('api/ai-workspace/questions/<int:question_log_id>/delete/', views.ai_workspace_question_log_delete_api, name='ai_workspace_question_log_delete_api'),
    ...
    path('api/ai-workspace/memories/', views.ai_workspace_memories_api, name='ai_workspace_memories_api'),
    path('api/ai-workspace/memories/create/', views.ai_workspace_memory_create_api, name='ai_workspace_memory_create_api'),
    path('api/ai-workspace/memories/<int:memory_id>/update/', views.ai_workspace_memory_update_api, name='ai_workspace_memory_update_api'),
    path('api/ai-workspace/memories/<int:memory_id>/toggle-active/', views.ai_workspace_memory_toggle_active_api, name='ai_workspace_memory_toggle_active_api'),
    ...
    path('api/prepayments/account/<int:department_id>/', views.prepayment_account_api, name='prepayment_account_api'),
