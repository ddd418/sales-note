...
urlpatterns = [
    ...
    path('api/tasks/assignees/', lazy_view('todos.views.tasks_assignees_api'), name='tasks_assignees_api'),
    path('api/tasks/customers/', lazy_view('todos.views.tasks_customers_api'), name='tasks_customers_api'),
    ...
    path('api/companies/manage/', lazy_view('reporting.api.accounts.companies_management_api'), name='companies_management_api'),
    path('api/companies/create/', lazy_view('reporting.api.accounts.company_create_api'), name='company_create_api'),
    path('api/departments/create/', lazy_view('reporting.api.accounts.department_create_api'), name='department_create_api'),
    path('api/companies/<int:company_id>/update/', lazy_view('reporting.api.accounts.company_update_api'), name='company_update_api'),
    path('api/companies/<int:company_id>/delete/', lazy_view('reporting.api.accounts.company_delete_api'), name='company_delete_api'),
    path('api/departments/<int:department_id>/update/', lazy_view('reporting.api.accounts.department_update_api'), name='department_update_api'),
    path('api/departments/<int:department_id>/delete/', lazy_view('reporting.api.accounts.department_delete_api'), name='department_delete_api'),
    ...
    path('api/customers/', lazy_view('reporting.api.accounts.customers_summary_api'), name='customers_summary_api'),
    path('api/customer-assets/', lazy_view('reporting.api.assets.customer_assets_summary_api'), name='customer_assets_summary_api'),
    path('api/customer-assets/account-search/', lazy_view('reporting.api.assets.customer_asset_account_search_api'), name='customer_asset_account_search_api'),
    path('api/customer-assets/create/', lazy_view('reporting.api.assets.customer_asset_directory_create_api'), name='customer_asset_directory_create_api'),
    path('api/services/', lazy_view('reporting.api.assets.service_cases_summary_api'), name='service_cases_summary_api'),
    path('api/customer-assets/<int:asset_id>/update/', lazy_view('reporting.api.assets.customer_asset_directory_update_api'), name='customer_asset_directory_update_api'),
    path('api/customer-assets/<int:asset_id>/service-cases/create/', lazy_view('reporting.api.assets.customer_asset_directory_service_case_save_api'), name='customer_asset_directory_service_case_create_api'),
    path('api/customer-assets/<int:asset_id>/service-cases/<int:case_id>/update/', lazy_view('reporting.api.assets.customer_asset_directory_service_case_save_api'), name='customer_asset_directory_service_case_update_api'),
    path('api/customer-assets/<int:asset_id>/calibrations/create/', lazy_view('reporting.api.assets.customer_asset_directory_calibration_save_api'), name='customer_asset_directory_calibration_create_api'),
    ...
    path('api/accounts/<int:department_id>/contacts/<int:followup_id>/update/', lazy_view('reporting.api.accounts.account_contact_save_api'), name='account_contact_update_api'),
    path('api/accounts/<int:department_id>/cleanup-preview/', lazy_view('reporting.api.accounts.account_cleanup_preview_api'), name='account_cleanup_preview_api'),
    path('api/accounts/<int:department_id>/cleanup-merge/', lazy_view('reporting.api.accounts.account_cleanup_department_merge_api'), name='account_cleanup_department_merge_api'),
    path('api/accounts/<int:department_id>/delivery-records.xlsx', lazy_view('reporting.api.accounts.account_delivery_records_xlsx_export_api'), name='account_delivery_records_xlsx_export_api'),
    path('api/customers/<int:followup_id>/', lazy_view('reporting.api.accounts.customer_detail_summary_api'), name='customer_detail_summary_api'),
    path('api/customers/<int:followup_id>/cleanup-merge/', lazy_view('reporting.api.accounts.account_cleanup_contact_merge_api'), name='account_cleanup_contact_merge_api'),
    path('api/customers/<int:followup_id>/delivery-records.xlsx', lazy_view('reporting.api.accounts.customer_delivery_records_xlsx_export_api'), name='customer_delivery_records_xlsx_export_api'),
    path('api/customers/<int:followup_id>/update/', lazy_view('reporting.api.accounts.customer_update_api'), name='customer_update_api'),
    path('api/customers/<int:followup_id>/delete/', lazy_view('reporting.api.accounts.customer_delete_api'), name='customer_delete_api'),
    path('api/customers/<int:followup_id>/assets/create/', lazy_view('reporting.api.assets.customer_asset_save_api'), name='customer_asset_create_api'),
    path('api/customers/<int:followup_id>/assets/<int:asset_id>/update/', lazy_view('reporting.api.assets.customer_asset_save_api'), name='customer_asset_update_api'),
    path('api/customers/<int:followup_id>/service-cases/create/', lazy_view('reporting.api.assets.customer_service_case_save_api'), name='customer_service_case_create_api'),
    path('api/customers/<int:followup_id>/service-cases/<int:case_id>/update/', lazy_view('reporting.api.assets.customer_service_case_save_api'), name='customer_service_case_update_api'),
    path('api/customers/<int:followup_id>/calibrations/create/', lazy_view('reporting.api.assets.customer_calibration_save_api'), name='customer_calibration_create_api'),
    path('api/customers/<int:followup_id>/calibrations/<int:record_id>/update/', lazy_view('reporting.api.assets.customer_calibration_save_api'), name='customer_calibration_update_api'),
    ...
    path('api/schedules/<int:schedule_id>/ai-coach/', lazy_view('reporting.api.ai.schedule_ai_coach_api'), name='schedule_ai_coach_api'),
    ...
    path('api/ai-workspace/', lazy_view('reporting.api.ai.ai_workspace_summary_api'), name='ai_workspace_summary_api'),
    path('api/ai-workspace/questions/<int:question_log_id>/', lazy_view('reporting.api.ai.ai_workspace_question_log_detail_api'), name='ai_workspace_question_log_detail_api'),
    path('api/ai-workspace/questions/<int:question_log_id>/delete/', lazy_view('reporting.api.ai.ai_workspace_question_log_delete_api'), name='ai_workspace_question_log_delete_api'),
    path('api/ai-workspace/question/', lazy_view('reporting.api.ai.ai_workspace_department_question_api'), name='ai_workspace_question_api'),
    path('api/ai-workspace/department-question/', lazy_view('reporting.api.ai.ai_workspace_department_question_api'), name='ai_workspace_department_question_api'),
    path('api/ai-workspace/question/feedback/', lazy_view('reporting.api.ai.ai_workspace_question_feedback_api'), name='ai_workspace_question_feedback_api'),
    path('api/ai-workspace/memories/', lazy_view('reporting.api.ai.ai_workspace_memories_api'), name='ai_workspace_memories_api'),
    path('api/ai-workspace/memories/create/', lazy_view('reporting.api.ai.ai_workspace_memory_create_api'), name='ai_workspace_memory_create_api'),
    path('api/ai-workspace/memories/<int:memory_id>/update/', lazy_view('reporting.api.ai.ai_workspace_memory_update_api'), name='ai_workspace_memory_update_api'),
    path('api/ai-workspace/memories/<int:memory_id>/toggle-active/', lazy_view('reporting.api.ai.ai_workspace_memory_toggle_active_api'), name='ai_workspace_memory_toggle_active_api'),
    path('api/ai-workspace/actions/draft/', lazy_view('reporting.api.ai.ai_workspace_action_draft_api'), name='ai_workspace_action_draft_api'),
    path('api/ai-workspace/actions/feedback/', lazy_view('reporting.api.ai.ai_workspace_action_feedback_api'), name='ai_workspace_action_feedback_api'),
    ...
    path('prepayment/<int:pk>/transfer/', react_page_redirect(
        lazy_view('reporting.api.prepayments.prepayment_transfer_view'),
        lambda request, pk: frontend_url(
            f'prepayments/{pk}/',
    ...
    path('prepayment/customer/<int:customer_id>/', react_page_redirect(
        lazy_view('reporting.api.prepayments.prepayment_customer_view'),
        lambda request, customer_id: frontend_url(
            f'prepayments/customer/{customer_id}/',
            query_with(request),
        ),
    ), name='prepayment_customer'),
    path('prepayment/customer/<int:customer_id>/excel/', lazy_view('reporting.api.prepayments.prepayment_customer_excel'), name='prepayment_customer_excel'),
    path('prepayment/account/<int:department_id>/excel/', lazy_view('reporting.api.prepayments.prepayment_account_excel'), name='prepayment_account_excel'),
    path('prepayment/excel/', lazy_view('reporting.api.prepayments.prepayment_list_excel'), name='prepayment_list_excel'),
    
    # 선결제 API
    path('api/prepayments/', lazy_view('reporting.api.prepayments.prepayment_api_list'), name='prepayment_api_list'),
    path('api/prepayments/create/', lazy_view('reporting.api.prepayments.prepayment_create_api'), name='prepayment_create_api'),
    path('api/prepayments/account/<int:department_id>/', lazy_view('reporting.api.prepayments.prepayment_account_api'), name='prepayment_account_api'),
    path('api/prepayments/customer/<int:customer_id>/', lazy_view('reporting.api.prepayments.prepayment_customer_api'), name='prepayment_customer_api'),
    path('api/prepayments/<int:pk>/', lazy_view('reporting.api.prepayments.prepayment_detail_api'), name='prepayment_detail_api'),
    path('api/prepayments/<int:pk>/update/', lazy_view('reporting.api.prepayments.prepayment_update_api'), name='prepayment_update_api'),
    path('api/prepayments/<int:pk>/cancel/', lazy_view('reporting.api.prepayments.prepayment_cancel_api'), name='prepayment_cancel_api'),
    path('api/prepayments/<int:pk>/delete/', lazy_view('reporting.api.prepayments.prepayment_delete_api'), name='prepayment_delete_api'),
    path('api/prepayments/<int:pk>/transfer/', lazy_view('reporting.api.prepayments.prepayment_transfer_api'), name='prepayment_transfer_api'),
    ...
    path('api/mailbox/scheduled/<int:scheduled_email_id>/', lazy_view('reporting.gmail_views.mailbox_api_scheduled_detail'), name='mailbox_api_scheduled_detail'),
