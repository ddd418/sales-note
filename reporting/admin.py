...
from .models import (
    ...
    Product, Quote, QuoteItem, FunnelStage, OpportunityTracking, Prepayment, PrepaymentLedgerEntry, PrepaymentUsage,
    Company, Department, DepartmentMemo, DocumentTemplate, CustomerCategory
)
...
class ScheduleAdmin(admin.ModelAdmin):
    list_display = ('followup', 'user', 'activity_type', 'delivery_payment_type', 'delivery_payment_status', 'visit_date', 'visit_time', 'location', 'status', 'created_at')
    list_filter = ('status', 'activity_type', 'delivery_payment_type', 'delivery_payment_status', 'user', 'visit_date')
