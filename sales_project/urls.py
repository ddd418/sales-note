...
urlpatterns = [
    ...
    re_path(
        r'^(?P<path>(?:dashboard|customers|accounts|demos|notes|schedules|employees|documents|products|receivables|prepayments|profile|pipeline|pipeline-sheet|revenue|companies)(?:/.*)?)$',
